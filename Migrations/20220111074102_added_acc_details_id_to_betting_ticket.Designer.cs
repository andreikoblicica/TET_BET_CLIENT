...
namespace TET_BET.Migrations
{
    ...
    [Migration("20220111074102_added_acc_details_id_to_betting_ticket")]
    partial class added_acc_details_id_to_betting_ticket
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TET_BET.Models.DBAppConfigs", b =>
                {
                    b.Property<int>("appConfigID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<string>("appConfigKey")
                        .HasColumnType("text");

                    b.Property<string>("appConfigValue")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("TET_BET.Models.DBBet", b =>
                {
                    ...
                    b.Property<int?>("DBFootballEventfootballEventID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DBFootballEventfootballEventID");
            ...
            modelBuilder.Entity("TET_BET.Models.DBBet", b =>
                {
                    b.HasOne("TET_BET.Models.DBFootballEvent", null)
                        .WithMany("bets")
                        .HasForeignKey("DBFootballEventfootballEventID");
